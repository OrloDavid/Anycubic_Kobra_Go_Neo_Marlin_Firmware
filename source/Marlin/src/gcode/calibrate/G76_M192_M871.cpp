 ...
 *
 * This file is not in Bugfix 2.0.x
 * G76_M871.cpp uis equiv
 * This file is in the following versions
 * 2.0.73
 * 2.0.81
 * 2.0.83
 * 2.0.8 LTS
 *
 * 2.0.73 is closest match
 *
 */
 ...
 *    Compensation values are deltas to first probe measurement at probe temp. = 30C.
 *  - When calibrating bed, probe temperature is held constant.
 *    Compensation values are deltas to first probe measurement at bed temp. = 60C.
 *  - The hotend will not be heated at any time.
 *  - On my Pra MK3S clone I put a piece of paper between the probe and the hotend
 ...
 *  - Heats up bed to 100C.
 *  - Moves probe to probing point (1mm above heatbed).
 *  - Waits until probe reaches target temperature (30C).
 *  - Does a z-probing (=base value) and increases target temperature by 5C.
 *  - Waits until probe reaches increased target temperature.
 *  - Does a z-probing (delta to base value will be a compensation value) and increases target temperature by 5C.
 ...
 *  - Moves probe to probing point (1mm above heatbed).
 *  - Waits until probe reaches target temperature (30C).
 *  - Does a z-probing (=base value) and increases bed temperature by 5C.
 *  - Moves probe to cooldown point.
 *  - Waits until probe is below 30C and bed has reached target temperature.
 *  - Moves probe to probing point and waits until it reaches target temperature (30C).
 *  - Does a z-probing (delta to base value will be a compensation value) and increases bed temperature by 5C.
 *  - Repeats last four points until max. bed temperature reached (110C) or timeout.
 *  - Compensation values of higher temperatures will be extrapolated (using linear regression first).
 *    While this is not exact by any means it is still better than simply using the last compensation value.
 *
 *  G76 [B | P]
