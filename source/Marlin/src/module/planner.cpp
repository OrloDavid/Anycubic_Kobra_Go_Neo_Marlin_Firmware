 ...
 * --
 *
 * The fast inverse function needed for Bzier interpolation for AVR
...
void Planner::set_max_jerk(const AxisEnum axis, float targetValue) {
  ...
  uint16_t Planner::block_buffer_runtime() {
    ...
    // To translate s to ms a division by 1000 would be required.
