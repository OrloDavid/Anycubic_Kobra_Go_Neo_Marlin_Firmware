         ...
         if(currentTemperature<220)
           {
              ...
              tft_string.trim();
              tft.add_text(0,5,COLOR_FOREGROUND,tft_string);     
              ...
              tft.add_text(30,0,COLOR_FOREGROUND, i16tostr3rj(currentTemperature));
              tft.add_text(70,0,COLOR_FOREGROUND, "/"); 
              tft.add_text(80,0,COLOR_FOREGROUND, i16tostr3rj(targetTemperature));
          }     
